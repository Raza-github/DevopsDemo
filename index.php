...
<!-- ================================== TOP NAVIGATION : END ================================== -->
		<!--	</div><!-- /.sidemenu-holder -->	
			...
			<div class="col-xs-12 col-sm-12 col-md-16 homebanner-holder"> 
				<!-- ========================================== SECTION – HERO ========================================= -->
			
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		<div class="full-width-slider" "full">	
		
			<div class="item" style="background-image: url(assets/images/sliders/friuts.png)" >
				<!-- /.container-fluid -->
			</div><!-- /.item -->
...
<!-- ============================================== SCROLL TABS ============================================== -->
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">FRIUTS</h3>
	...
	<div class="product">		
		...
		<div class="product-info text-left">
			...
			<div class="product-price">	
				<span class="price">
					Rs/kg.<?php echo htmlentities($row['productPrice']);?>			</span>
...
<?php include('includes/footer.php');?>
	...
	<script src="assets/js/jquery-1.11.1.min.js"></sscript>
