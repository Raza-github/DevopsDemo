...
$sql=mysqli_query($con,"insert into products(productName,productPrice,productAvailability,productImage1,productPriceBeforeDiscount) values('$productname','$productprice','$productavailability','$productimage1','$productpricebd')");
