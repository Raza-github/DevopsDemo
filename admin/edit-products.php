...
$sql=mysqli_query($con,"update  products set productName='$productname',productPrice='$productprice',productAvailability='$productavailability',productPriceBeforeDiscount='$productpricebd' where id='$pid' ");
